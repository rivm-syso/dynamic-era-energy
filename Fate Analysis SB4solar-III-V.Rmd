...
for(i in 1:length(cases[,1])){
  ...
  Emis.Loc <- paste0("data/Emis PV data III-V/PV_emissions_v1.7_LOC_",cases$Recycling[i],"_",cases$substance[i],"_kg.xlsm")
  Emis.Reg <- paste0("data/Emis PV data III-V/PV_emissions_v1.7_AM_",cases$Recycling[i],"_",cases$substance[i],"_kg.xlsm") 
  Emis.Cont <-paste0("data/Emis PV data III-V/PV_emissions_v1.7_EU_",cases$Recycling[i],"_",cases$substance[i],"_kg.xlsm") 
  ...
  ADDRISKdata <- paste0("data/SBMatrix III-V/",cases$substance[i],"_SB4DIRECT @RISK output to K-matrix_25102021.xlsx")
