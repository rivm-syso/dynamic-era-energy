...
pdf(paste0('RQ.pdf'), width = 12, height = 6)
...
write.xlsx(data.frame(old.lvl), file = "Names_borg_d.xlsx", sheetName="oldlvl")

# introduce in a new sheet named "newlvl" the preferred order and names for the sensitivity factors
new.lvl <- read_excel("Names_borg_d.xlsx",sheet="newlvl")

borg_d$Factor <- factor(borg_d$Factor, levels = rev(new.lvl$Variable))

pdf(paste0('GSA_tot_20230505.pdf'), width=8,height=11)
