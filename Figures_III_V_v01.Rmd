...
ggsave(filename = paste0("PEC_",cases$paneltype[1],"_v1.jpg"),
       plot = last_plot(),
       device = "jpeg",
       path = "figures",
       scale = 2,
...
for (s in substances){
  for (o in option){
    for (c in comp){
      ...
      probX <- probX[-4,]
      #probX <- probX[-bad_rows,]  #remove rows with errors
      ...
      probX2 <- subset(probX1, select = !(colnames(probX1) %in% c("Kpsoil.silver","Kpsoil.As","Kpsoil.copper","Kpsoil.Ga","Kpsoil.In","Kpsoil.lead","Koc.DHPS","v./.aL","v./.wL","v./.sdL","v./.aR","v./.w1R","v./.sd1R","v./.aC","v./.w1C","v./.sd1C","v./.sd2C","v./.w0C", "v./.w2C", "v./.s1C", "v./.s2C", "v./.s3C", "v./.aM", "v./.w2M","v./.w3M","v./.sdM", "v./.sM")))
